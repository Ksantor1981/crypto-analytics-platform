...
test.describe('Crypto Analytics Platform E2E Tests', () => {
  ...
  test.describe('Dashboard', () => {
    ...
    test('should display dashboard with user metrics', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="recent-signals"]')
      ).toBeVisible();
  ...
  test.describe('Channels Management', () => {
    ...
    test('should display channels list', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="add-channel-button"]')
      ).toBeVisible();
    });
    ...
    test('should add new channel', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="channel-card"]')).toContainText(
        'Test Channel'
      );
    });
  ...
  test.describe('Signals View', () => {
    ...
    test('should display signals table', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="signals-filters"]')
      ).toBeVisible();
    });
    ...
    test('should view signal details', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="signal-details-modal"]')
      ).toBeVisible();
  ...
  test.describe('User Profile', () => {
    ...
    test('should change password', async ({ page }) => {
      ...
      ).toContainText('Пароль успешно изменен');
    });
  });
  ...
  test.describe('Subscription Management', () => {
    ...
    test('should display subscription plans', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="subscription-plans"]')
      ).toBeVisible();
    ...
    test('should upgrade to premium plan', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="success-message"]')
      ).toContainText('Подписка успешно оформлена');
    });
  });
  ...
  test.describe('Error Handling', () => {
    test('should handle 404 errors', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="back-home-button"]')
      ).toBeVisible();
    });
