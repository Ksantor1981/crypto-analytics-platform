...
- В `docker-compose*.yml` не должно оставаться известных шаблонов вроде `REDACTED` в новых коммитах; CI проверяет часть путей.
