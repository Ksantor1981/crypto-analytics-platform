...
def test_celery_tasks():
    ...
    try:
        from tasks import collect_telegram_signals, check_signal_results
        
        print("✅ Celery tasks imported successfully")
        
        # Test telegram signals task
        print("   Testing collect_telegram_signals task...")
        telegram_result = collect_telegram_signals()
        print(f"   ✅ Telegram task result: {telegram_result.get('status')}")
        
        # Test signal results task  
        print("   Testing check_signal_results task...")
        results_result = check_signal_results()
        print(f"   ✅ Results task result: {results_result.get('status')}")
